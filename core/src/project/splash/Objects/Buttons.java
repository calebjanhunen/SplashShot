 ...
 * @author Dennis
 */
public class Buttons extends Sprite { //Learning how to implement buttons: https://github.com/brauj1894/Risk/blob/master/core/src/gdx/game/objects/Button.java
    int nX, nY, nW, nH;
